...
setLoading(true)
      setTimeout(()=>{
        emailjs.sendForm('service_lsaf9ax', 'template_unys6y5', form.current, 'kqR3l0Mh6hRgpGCJG')
        .then((result) => {
  ...
  return (
    <section class=" z-10 overflow-hidden bg-white " id="contact" name="contact">
        ...
        <div class="-mx-4 flex flex-wrap lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              <h2
                ...
                mb-6 uppercase font-bold text-lg font-poppins"
              >
                GET IN TOUCH WITH ME<span className='text-secondary'>.</span>
              </h2>
              
              <div class="mb-8 flex w-full max-w-[370px] font-poppins">
                <div
                  class="bg-primary text-primary mr-6 flex 
                  font-poppins
                  h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                >
                  <svg
                    width="24"
                    height="24"
                ...
                <div class="w-full">
                  <h4 class="text-secondary mb-1 text-xl font-bold"> Location</h4>
                  <p class="text-gray-700 text-sm font-poppins">
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                <div
                  class="bg-primary text-primary mr-6 
                  flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                >
                  <svg
                    width="24"
                    height="26"
                ...
                <div class="w-full font-poppins">
                  <h4 class="text-secondary mb-1 text-xl font-bold">Phone Number</h4>
                  <p class="text-gray-700 text-sm">(+62)81 414 257 9980</p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px] font-poppins">
                <div
                  class="bg-primary text-primary mr-6 flex h-[60px] 
                  w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                >
                  <svg
                    width="28"
                    height="19"
                ...
                <div class="w-full">
                  <h4 class="text-secondary mb-1 text-xl font-bold">Email Address</h4>
                  <p class="text-gray-700 text-sm">info@yourdomain.com</p>
                </div>
              </div>
            </div>
          </div>
          <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div class="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
              {loading &&<div class="flex items-center 
             bg-secondary opacity-80 text-white text-sm font-bold px-4 py-3 mb-5"
             role="alert">
  <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" 
  viewBox="0 0 20 20">
    <path d="M12.432 0c1.34 0 2.01.912 2.01 1.957 0 1.305-1.164 2.512-2.679 2.512-1.269 0-2.009-.75-1.974-1.99C9.789 1.436 10.67 0 12.432 0zM8.309 20c-1.058 0-1.833-.652-1.093-3.524l1.214-5.092c.211-.814.246-1.141 0-1.141-.317 0-1.689.562-2.502 1.117l-.528-.88c2.572-2.186 5.531-3.467 6.801-3.467 1.057 0 1.233 1.273.705 3.23l-1.391 5.352c-.246.945-.141 1.271.106 1.271.317 0 1.357-.392 2.379-1.207l.6.814C12.098 19.02 9.365 20 8.309 20z"/></svg>
  <p className='font-poppins text-white'>Message Has Sent Successfully.</p>
</div> }
              ...
              <form ref={form} onSubmit={sendEmail}> 
                ...
                <div>
                  <button
                    type="submit"
                    class="bg-secondary border-primary w-full font-poppins rounded border p-3
